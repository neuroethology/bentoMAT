function launchBTA(source,~)
    ...
    set(hfig,'dockcontrols','off','menubar','none',...
            ...
            'Position',[550 70 600 700],'AutoResizeChildren','off','SizeChangedFcn',@resizeBTAwindow);
    gui.browser    = hfig;
    h.hfig = hfig;
    h.h0 = gui.h0;

    % plotting panel-------------------------------------------------------
    h.panelPlots = uipanel('parent',hfig,'units','pixels','position',[250 0 350 700],'bordertype','none');
    ...
    % control panel--------------------------------------------------------
    h.panelCtrl        = uipanel('parent',hfig,'units','pixels','position',[0 0 250 700],'bordertype','none');
    drawnow;
    ...
    for j = 1:ceil(nbeh/ncol)
        ...
        for i = 1:ncol
            ...
            h.bhvrs(b) = uicontrol('parent',h.panelCtrl,'Style','checkbox',...
                    'Value',1,...
                    'Position',[30+(i-1)*120 bump+13 21 21],...
