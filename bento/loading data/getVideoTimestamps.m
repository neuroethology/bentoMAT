function timestamps = getVideoTimestamps(video, suffix)
    ...
    camfile_formats = {fullfile(pth2,[fid2 '_logfile.txt']), fullfile(pth,[fid '_logfile.txt']), ...
                       fullfile(pth2,[fid2 '_timeStamps.txt']), fullfile(pth,[fid '_timeStamps.txt']), ...
                       fullfile(pth2,'timeStamps.txt'), fullfile(pth,'timeStamps.txt'), ...
    ...
    camfile_formats = {fullfile(pth2,[fid2 '_logfile.csv']), fullfile(pth,[fid '_logfile.csv']), ...
                       fullfile(pth2,[fid2 '_timeStamps.csv']), fullfile(pth,[fid '_timeStamps.csv']), ...
                       fullfile(pth2,'timeStamps.csv'), fullfile(pth,'timeStamps.csv'), ...
